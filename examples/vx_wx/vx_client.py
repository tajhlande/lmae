...
def get_conditions_and_forecast_by_zipcode(zipcode: str, api_key: str):
    # endpoint = f'https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/{zipcode}?unitGroup=us&include=current&key={api_key}&contentType=json&lang=id'  # noqa: E501
    ...
    filtered_endpoint = (
        ...
        f"key={api_key}&contentType=json&lang=id"
    )
