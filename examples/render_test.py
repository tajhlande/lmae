...
small_font = ImageFont.truetype(os.path.join(resource_path, "fonts/teeny-tiny-pixls-font/TeenyTinyPixls-o2zo.ttf"), 5)
...
lmae_shadow_text_2 = Text(name='LMAE shadow text 2', text="LMAE",
                          ...
                          font=large_font, color=(0, 255, 0, 255), stroke_width=0)
