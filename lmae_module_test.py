...
kirby_anim = Sequence(name="Kirby Repeat", actor=kirby, repeat=True,
                      animations=[LinearMove(name='Kirby go right', distance=(0, 64 - kirby_move_dist), duration=2.0),
                                  LinearMove(name='Kirby go left', distance=(0, -64 + kirby_move_dist), duration=2.0)])
